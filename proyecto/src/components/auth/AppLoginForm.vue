  ...
  methods: {
    async handleSubmit() {
      ...
      try {
       ...
       this.errorMessage="Error al loguearse email / password incorrecto";
      ...
      <div class="w-80">
        <form action="#" @submit.prevent="handleSubmit">
          ...
          <div class="flex flex-col gap-3">
            ...
            <RouterLink
              to="/registrarse"
              class="w-full inline-block px-5 py-3 bg-lime-800 text-center text-white rounded-2xl shadow hover:bg-lime-900 transition"
            >
              Registrate
            </RouterLink>
          </div>
