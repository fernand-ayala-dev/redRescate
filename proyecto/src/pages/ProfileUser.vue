...
import AppH2 from "../components/estilos/AppH2.vue";
import AppLoaders from "../components/estilos/AppLoaders.vue";
...
<template>
  <div class="p-4 bg-amber-300/40">
    ...
    <div v-else class="p-4">
      ...
      <div
        v-else
        class="w-9/12 md:w-9/12 mx-auto h-[80vh] overflow-y-auto p-6 bg-black/10 rounded-3xl shadow-inner border border-gray-200"
      >
